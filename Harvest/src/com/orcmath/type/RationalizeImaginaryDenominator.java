...
public class RationalizeImaginaryDenominator extends Type{

private String[] variationsOnInstructions= {"Rationalize the denominator of the following fraciotn", "Simplify"};
	
	
public RationalizeImaginaryDenominator(){
...
public RationalizeImaginaryDenominator(int difficulty){
		instructions = variationsOnInstructions[Ops.randomInt(0, (variationsOnInstructions.length)-1)];
		numberOfColumns=2;
		verticalSpacing=120;
		whetherInstructionsAreNeverIncluded=false;
	...
	private void getInstance(int difficulty) {
		...
		question = "\\frac{" + Format.termArrayToString(numeratorTerms) + "}{" + Format.termArrayToString(denominatorTerms) + "}";
